...
class Light2ControlScreen extends StatefulWidget {
  @override
  _Light2ControlScreenState createState() => _Light2ControlScreenState();
}

class _Light2ControlScreenState extends State<Light2ControlScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text("Điều Khiển Đèn 2",
