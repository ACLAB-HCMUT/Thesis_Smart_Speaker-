...
def process_command(command):
    ...
    if any(keyword in command for keyword in ["lấy lịch", "xem lịch", "hiển thị lịch", "danh sách sự kiện"]):
        ...
        get_current_time()
    elif any(keyword in command for keyword in ["thêm lịch", "tạo sự kiện", "lên lịch"]): # thêm lịch bị trùng với câu chat GPT, bỏ đi, hạn chế chữ lịch, nó sẽ nhận diện ra sai: chữ lệnh, chữ lệch,...
